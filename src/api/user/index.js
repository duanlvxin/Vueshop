...
//上传头像
export function uploadAvaterService(headfile){
    return request(config.baseApi + "user/myinfo/formdatahead?token=" + config.token,"file",{headfile:headfile})
}
